            ...
            {({ project }) => (
              ...
              >
                ...
                <div className='px-5'>
                          ...
                          >
                            {Utils.getIsEdge() ? (
                              ...
                              <Tooltip title='Migrating to Edge'>
                                Depending on the amount of project data,
                                migrating can take a while. Refresh the page to
                                track progress.
                              </Tooltip>
                            ) : (
                              'Core'
                  ...
                  <div className='row ms-0 me-0 aside__wrapper'>
                    <div className='aside__main-content px-0'>
                      <div className='ps-4 pe-4 pt-4'></div>
                      <Permission
                        level='project'
                        permission='ADMIN'
                        id={this.props.projectId}
                          ...
                          {({ permission }) =>
                            permission && (
                              <NavLink
                                ...
                                exact
                              >
                                <i className='icon me-2 ion-ios-apps aside__nav-item--icon' />
                                Integrations
                              </NavLink>
                            )
                          }
                      ...
                      <div className='align-self-end'>
                        {Utils.getFlagsmithHasFeature('demo_feature') && (
                          ...
                          >
                            <i className='icon me-2 ion-ios-star aside__nav-item--icon' />
                          ...
                          <div className='text-muted text-small text-center'>
                            {this.state.version.tag !== 'Unknown' && (
                              <Tooltip
                                ...
                                title={
                                  <span>
                                    <span className='ms-2 icon ion-ios-pricetag' />{' '}
                                    {this.state.version.tag}
                                  </span>
                                }
                              >
                                {`${
                                  this.state.version.frontend_sha !== 'Unknown'
                                    ? `Frontend SHA: ${this.state.version.frontend_sha}`
                                    : ''
                                }${
                                  this.state.version.backend_sha !== 'Unknown'
                                    ? `${
